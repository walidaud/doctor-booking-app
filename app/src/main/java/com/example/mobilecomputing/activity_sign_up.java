...
import com.example.mobilecomputing.databinding.ActivitySignUpBinding;
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mAuth.createUserWithEmailAndPassword(email, pass)
                        .addOnCompleteListener(activity_sign_up.this, new OnCompleteListener<AuthResult>() {
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (!task.isSuccessful()) {
                                    Toast.makeText(activity_sign_up.this, "ERROR", Toast.LENGTH_LONG).show();
                                } else {
                                    ...
                                    //startActivity(new Intent(activity_sign_up.this, activity_navigation.class));                          REMOVE THIS
                                    finish();
                                }
                            }
                        });
